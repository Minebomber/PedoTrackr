//
//  ClusteredPedoAnnotationView.m
//  PedoTrackr
//
//  Created by Mark Lagae on 11/11/17.
...
@interface ClusteredPedoAnnotationView ()
@property (strong, nonatomic) UILabel *countLabel;
@end

@implementation ClusteredPedoAnnotationView
...
- (void)drawRect:(CGRect)rect
{
    ...
    UIColor *innerCircleFillColor = [UIColor colorWithRed:(11.0 / 255.0) green:(69.0 / 255.0) blue:(163.0 / 255.0) alpha:1.0];
